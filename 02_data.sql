...
(1,  'Ramiro',   'Achaval',        'ramiro.ach@chof.ar',        '+54 9 3764 11-4001', 'MIS-0001-AR', 'conectado',   ST_SRID(POINT(-27.3680, -55.8969), 4326)),
(2,  'Milagros', 'Bidegain',       'mili.bid@chof.ar',          '3764-22-4002',       'MIS-0002-AR', 'desconectado',ST_SRID(POINT(-27.3700, -55.9000), 4326)),
(3,  'Benicio',  'Carignano',      'beni.carig@chof.ar',        '3765-33-4003',       'MIS-0003-AR', 'enviaje',     ST_SRID(POINT(-27.3650, -55.8888), 4326)),
(4,  'Micaela',  'Dromi',          'mica.dromi@chof.ar',        '+54 3765 44 4004',   'MIS-0004-AR', 'conectado',   ST_SRID(POINT(-27.3789, -55.9123), 4326)),
(5,  'Lisandro', 'Etchegorry',     'lisan.etche@chof.ar',       '3764-55-4005',       'MIS-0005-AR', 'conectado',   ST_SRID(POINT(-27.3620, -55.8950), 4326)),
(6,  'Aldana',   'Falotico',       'aldana.falot@chof.ar',      '3765-66-4006',       'MIS-0006-AR', 'desconectado',ST_SRID(POINT(-27.3850, -55.9050), 4326)),
(7,  'Nicolas',  'Gerez',          'n.gerez@chof.ar',           '3764-77-4007',       'MIS-0007-AR', 'conectado',   ST_SRID(POINT(-27.3690, -55.8910), 4326)),
(8,  'Irene',    'Haidar',         'irene.haidar@chof.ar',      '3765-88-4008',       'MIS-0008-AR', 'enviaje',     ST_SRID(POINT(-27.3720, -55.9020), 4326)),
(9,  'Teo',      'Iramain',        'teo.iramain@chof.ar',       '3764-99-4009',       'MIS-0009-AR', 'desconectado',ST_SRID(POINT(-27.3660, -55.8990), 4326)),
(10, 'Ambar',    'Jelin',          'ambar.jelin@chof.ar',       '3764-10-4010',       'MIS-0010-AR', 'conectado',   ST_SRID(POINT(-27.3710, -55.8930), 4326)),
(11, 'Yamila',   'Kresak',         'yam.kresak@chof.ar',        '3765-11-4011',       'MIS-0011-AR', 'conectado',   ST_SRID(POINT(-27.3685, -55.8981), 4326)),
(12, 'Elias',    'Lugones',        'elias.lug@chof.ar',         '3764-12-4012',       'MIS-0012-AR', 'desconectado',ST_SRID(POINT(-27.3705, -55.9011), 4326)),
(13, 'Ariel',    'Mazzocchi',      'ariel.mazzo@chof.ar',       '+54 9 3765 13-4013', 'MIS-0013-AR', 'enviaje',     ST_SRID(POINT(-27.3655, -55.8899), 4326)),
(14, 'Agustina', 'Nocetti',        'agustina.noce@chof.ar',     '3765-14-4014',       'MIS-0014-AR', 'conectado',   ST_SRID(POINT(-27.3799, -55.9134), 4326)),
(15, 'Renata',   'Otaola',         'ren.otaola@chof.ar',        '3765-15-4015',       'MIS-0015-AR', 'conectado',   ST_SRID(POINT(-27.3625, -55.8961), 4326)),
(16, 'Nahir',    'Pintos',         'nahir.pintos@chof.ar',      '3765-16-4016',       'MIS-0016-AR', 'desconectado',ST_SRID(POINT(-27.3855, -55.9061), 4326)),
(17, 'Tadeo',    'Quatrini',       'tadeo.qua@chof.ar',         '3764-17-4017',       'MIS-0017-AR', 'conectado',   ST_SRID(POINT(-27.3695, -55.8921), 4326)),
(18, 'Luna',     'Ruata',          'luna.ruata@chof.ar',        '3764-18-4018',       'MIS-0018-AR', 'enviaje',     ST_SRID(POINT(-27.3725, -55.9031), 4326)),
(19, 'Santino',  'Santamarina',    'santi.santa@chof.ar',       '3764-19-4019',       'MIS-0019-AR', 'desconectado',ST_SRID(POINT(-27.3665, -55.9001), 4326)),
(20, 'Brenda',   'Tarditti',       'brenda.tardi@chof.ar',      '+54 3765 20-4020',   'MIS-0020-AR', 'conectado',   ST_SRID(POINT(-27.3715, -55.8941), 4326)),
(21, 'Julian',   'Ugarteche',      'julian.ugar@chof.ar',       '3765-21-4021',       'MIS-0021-AR', 'conectado',   ST_SRID(POINT(-27.3682, -55.8972), 4326)),
(22, 'Tamara',   'Vercellone',     'tam.vercell@chof.ar',       '3765-22-4022',       'MIS-0022-AR', 'desconectado',ST_SRID(POINT(-27.3702, -55.9002), 4326)),
(23, 'Eluney',   'Williman',       'eluney.will@chof.ar',       '3765-23-4023',       'MIS-0023-AR', 'enviaje',     ST_SRID(POINT(-27.3652, -55.8892), 4326)),
(24, 'Gaspar',   'Xirgu',          'gaspar.x@chof.ar',          '3765-24-4024',       'MIS-0024-AR', 'conectado',   ST_SRID(POINT(-27.3791, -55.9125), 4326)),
(25, 'Oriana',   'Yasky',          'oriana.y@chof.ar',          '3765-25-4025',       'MIS-0025-AR', 'conectado',   ST_SRID(POINT(-27.3622, -55.8952), 4326)),
(26, 'Matilde',  'Zupel',          'matilde.z@chof.ar',         '3764-26-4026',       'MIS-0026-AR', 'desconectado',ST_SRID(POINT(-27.3852, -55.9052), 4326)),
(27, 'Americo',  'Aizpun',         'americo.a@chof.ar',         '3765-27-4027',       'MIS-0027-AR', 'conectado',   ST_SRID(POINT(-27.3692, -55.8912), 4326)),
(28, 'Candel',   'Bock',           'candel.b@chof.ar',          '3764-28-4028',       'MIS-0028-AR', 'enviaje',     ST_SRID(POINT(-27.3722, -55.9022), 4326)),
(29, 'Nazareno', 'Cuneo Libarona', 'naza.cl@chof.ar',           '3765-29-4029',       'MIS-0029-AR', 'desconectado',ST_SRID(POINT(-27.3662, -55.8992), 4326)),
(30, 'Mirko',    'Dahbar',         'mirko.d@chof.ar',           '3765-30-4030',       'MIS-0030-AR', 'conectado',   ST_SRID(POINT(-27.3712, -55.8932), 4326));
